public class BinaryTreeMain14 {
    public static void main(String[] args) {
        ...
        BinaryTree14 bst2 = new BinaryTree14();
        System.out.println("\n-- addRekursif --");
        bst2.addRekursif(new Mahasiswa14("244160121", "Ali", "A", 3.57));
        bst2.addRekursif(new Mahasiswa14("244160221", "Badar", "B", 3.85));
        bst2.addRekursif(new Mahasiswa14("244160185", "Candra", "C", 3.21));
        bst2.addRekursif(new Mahasiswa14("244160220", "Dewi", "B", 3.54));
        bst2.addRekursif(new Mahasiswa14("244160131", "Devi", "A", 3.72));
        bst2.addRekursif(new Mahasiswa14("244160205", "Ehsan", "D", 3.37));
        bst2.addRekursif(new Mahasiswa14("244160170", "Fizi", "B", 3.46));
        System.out.println("Mahasiswa berhasil ditambahkan secara rekursif.");
